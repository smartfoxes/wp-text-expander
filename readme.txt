...
WP Text Expander, manage snippents of text across the website from the central location.
...
1. Alternatively, download the plugin and upload the contents of `wp-text-expander.zip` to your plugins directory, which usually is `/wp-content/plugins/`.
1. Activate the plugin
1. In WordPress dashboard open "Text Expander" tab located in the side menu and create your shortcodes with text snippets.
1. Use your shortcodes in your posts, pages, widgets, menus.

== Other Notes ==

#### Support

Use the [WordPress.org plugin forums](https://wordpress.org/support/plugin/wp-text-expander) for community support where we try to help all of our users. 
...
1. Manage your common text snippets from Admin's Dashboard, each snipped will have own shortcode
